...
import (
	...
	"ex-ui/logger"
	"ex-ui/util/common"
	"ex-ui/web/controller"
	"ex-ui/web/job"
	"ex-ui/web/locale"
	"ex-ui/web/middleware"
	"ex-ui/web/network"
	"ex-ui/web/service"
...
type Server struct {
	...
	panel  *controller.EXUIController
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("EXUI", store))
	...
	// Apply the redirect middleware (`/exui` to `/panel`)
	...
	s.panel = controller.NewEXUIController(g)
